...
SyncQueueItem _syncQueueItemDeserialize(
  ...
  final object = SyncQueueItem(
    ...
    retryCount: reader.readLongOrNull(offsets[2]) ?? 0,
...
extension SyncQueueItemQueryFilter
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterFilterCondition> typeEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterFilterCondition> typeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterFilterCondition> typeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension SyncQueueItemQuerySortBy
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueItemQuerySortThenBy
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<SyncQueueItem, SyncQueueItem, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension SyncQueueItemQueryWhereDistinct
  ...
  QueryBuilder<SyncQueueItem, SyncQueueItem, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SyncQueueItemQueryProperty
  ...
  QueryBuilder<SyncQueueItem, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
